...
public class InteractablesGUI {
    ...
    public static void open(Player player, Plot plot, PlotsPlugin plugin) {
        ...
        var interactablesService = plugin.serviceRegistry().getRegistered(InteractablesService.class);
        ...
        window.addCloseHandler((reason -> interactablesService.saveCurrentInteractables(plot)));
        window.open();
    }
}