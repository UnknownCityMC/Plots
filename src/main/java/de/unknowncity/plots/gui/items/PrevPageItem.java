...
public class PrevPageItem extends AbstractPagedGuiBoundItem {
    ...
    public PrevPageItem(ItemStack displayItem, PaperMessenger messenger, GuiSettings guiSettings) {
    ...
    public @NotNull ItemProvider getItemProvider(@NotNull Player player) {
        ...
        var builder = ItemBuilder.of(displayItem)
                .itemModel(NamespacedKey.fromString(guiSettings.buttonModelPrev()))
                .name(name)
                .lore(lore);
